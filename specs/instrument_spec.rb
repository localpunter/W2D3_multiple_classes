...
class InstrumentTest < Minitest::Test
  ...
  def test_can_make_sound
    assert_equal("I'm playing Stairway to Heaven!",
    @instrument.make_sound("Stairway to Heaven"))

  end

  def test_can_make_sound__piano
    piano = Instrument.new("piano")
    assert_equal("Plink plonk... I'm playing Ordinary People!",
    piano.make_sound("Ordinary People"))
